...
<body class="is-preload">
	...
	<div class="container">
		<br />
		<h2>Select a Political Science audiobook to listen to</h2>
        ...
        <div class="panel-heading">
          <h4 class="panel-title">
            <a data-toggle="collapse" data-parent="#accordion" href="#collapse4">2019</a>
          </h4>
        </div>
         ...
         else
         {
          echo substr($file,2,strlen($file)-6)."</br>";
              ...
              echo'<audio controls preload="none">';
                echo'<source src='.'"http://rotaractmora.org/rotaractmora_static/MH/voice_of_humanity_2019_AL_past_papers/Political_science/'. $file .'"';
