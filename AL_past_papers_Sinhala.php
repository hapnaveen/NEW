...
<body class="is-preload">
    ...
    $dir = scandir("./voice_of_humanity_2019_AL_past_papers/Sinhala/");
    $c=count($dir);
    sort($dir,1);
         ...
         else
         {
          echo substr($file,2,strlen($file)-6)."</br>";
              ...
              echo'<audio controls preload="none">';
                echo'<source src='.'"http://rotaractmora.org/rotaractmora_static/MH/voice_of_humanity_2019_AL_past_papers/Sinhala/'. $file .'"';
